...
//  OOL
//
//  Updated by Kegham Karsian on 12/5/17.
...
class AttrTextView: UITextView {
    ...
    public func setText(text: String, withHashtagColor hashtagColor: UIColor, andMentionColor mentionColor: UIColor,normalTexColor: UIColor, andCallBack callBack: @escaping (String, wordType) -> Void, normalFont: UIFont, hashTagFont: UIFont, mentionFont: UIFont) {
        ...
        attrString?.addAttribute(NSAttributedStringKey.foregroundColor, value: normalTexColor, range: NSRange(location: 0, length: (textString?.length)!))
